...
The <b>template method pattern</b> is normally used when your code always wants to do exactly the same thing.
Sometimes wants to do this, and sometimes it wants to do that.
...
rdoc-image:img/uml_diagram.png
